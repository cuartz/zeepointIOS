...
#import "ZiPJSQMessagesViewController.h"
...
@interface ZiPJSQMessagesViewController () <JSQMessagesInputToolbarDelegate,
...
@implementation ZiPJSQMessagesViewController
...
- (void)jsq_configureMessagesViewController
{
    ...
    self.toolbarHeightConstraint.constant = 0.0;//self.inputToolbar.preferredDefaultHeight;
    
    self.collectionView.dataSource = self;
    self.collectionView.delegate = self;
    
    self.inputToolbar.delegate = self;
    [self.inputToolbar.contentView removeFromSuperview];//checar esto
